  ...
  return {
    ...
    async reset() {
      ...
      await handle.pool.query(
        'TRUNCATE TABLE account_tokens, password_resets, ai_usage_days, sync_blobs, sync_key_records, sync_shares, research_contributions, research_withdrawals, signup_invites, accounts RESTART IDENTITY CASCADE',
      );
    },
  };
}
